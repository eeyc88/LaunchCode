...
class CabeceraSupervisionDronCollector extends Collector
{
  ...
  function insertCabeceraSupervisionDron($idperiodo, $fecha, $supervisor, $idcultivolote, $estado) 
  {
    $rows = self::$db->insertRow("Insert into controlAgricola.cabecerasupervisiondron (periodo, fecha, supervisor, idcultivolote, estado) values ('$idperiodo', '$fecha', '$supervisor', '$idcultivolote', '$estado' )" , null);             
  }
